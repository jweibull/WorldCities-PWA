...
namespace WorldCities.Data
{
    public class ApiResult<T>
    {
        ...
        /// <returns>
        /// A object containing the IQueryable paged/sorted/filtered result and all the relevant 
        ...
        public static async Task<ApiResult<T>> CreateAsync(
            ...
            string? filterQuery)
        {
            // In case there are filter queries, insert filter before actual select
            ...
            // In case there are sort parameters sort the future results
            ...
            //Retrieve a pageSize of type T skipping pageIndex times the pageSize
            source = source.Skip(pageIndex * pageSize).Take(pageSize);

            // Execute the sql query/queries built above and return the results
